...
$state = \SimpleSAML\Auth\State::loadState($_REQUEST['StateId'], 'authorizebydest:AuthorizeByDest');

$globalConfig = \SimpleSAML\Configuration::getInstance();
$t = new \SimpleSAML\XHTML\Template($globalConfig, 'authorizebydest:authorize_403.php');
